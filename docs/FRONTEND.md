...
| FE-16 | Verdict-tone model — six meaning-class tones (neutral/progress/positive/attention/halt/terminal) serve `assessment_status`, `lifecycle_state`, `classification_status`, `coverage_status`, `approval_status`, `eu_ai_act_tier`. Chip label carries the specific member, tone carries the class. Orthogonality rule: a channel never borrows another channel's visual slot. | INV-56, D-43, FE-7 |
