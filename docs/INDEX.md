...
- **Decisions:** `D-1..51` (+ sprint-local `DF1-3..9`, `DF3-1..7`, `DF4-1..6`, `DF5-1..11`, `DF6-1..10`, `DF7-1..3`, `DF8-1..3`, `DF-V1-1..2`); open questions `OPEN-1..4` + `OPEN-V1..V7`.
- **Patterns:** `PAT-1..10`.
