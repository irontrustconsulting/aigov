...
- **Decisions:** `D-1..39` (+ sprint-local `DF1-3..9`, `DF3-1..7`, `DF4-1..6`, `DF5-1..11`, `DF6-1..10`, `DF7-1..3`); open questions `OPEN-1..3`.
- **Patterns:** `PAT-1..10`.
