import { EmptyState, PageScaffold } from "@irontrust/ui";
...
export function NeedsSystemOwner() {
  return (
    <PageScaffold>
      <section aria-label="needs-system-owner">
        <EmptyState message="Starting a new system needs a system owner. Once a system owner registers it, you'll be able to help with any classification questions it raises." />
      </section>
    </PageScaffold>
  );
}
