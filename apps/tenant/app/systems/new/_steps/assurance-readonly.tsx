  ...
  return (
    <PageScaffold>
      <section aria-label="assurance-read-only">
        <EmptyState message="This is a capture surface for registering a new system. There is nothing for your role to review here yet — assessments you review will appear in the review queue once one exists." />
      </section>
    </PageScaffold>
  );
}
